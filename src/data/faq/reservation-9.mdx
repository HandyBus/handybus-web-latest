셔틀버스는 탑승 8일 전까지, 핸디팟은 6일 전까지 별도의 수수료 없이 예약을 취소할 수 있어요. 출발이 임박한 경우 또는 이미 출발한 경우에는 환불 규정에 따라 취소 수수료가 발생해요. 셔틀 유형별 자세한 환불 규정은 아래의 표를 참고해 주세요.
      ...
      <table className="w-full border-collapse">
        ...
        <tbody className="bg-basic-white font-500 text-basic-grey-600">
          ...
          <tr>
            ...
            <td className="px-[10px] py-[6px]">환불 불가</td>
          </tr>
        </tbody>
      </table>
    </div>
