      ...
      <BottomSheetPortal>
        ...
        >
          <div
            ...
            className="fixed -bottom-[800px] right-[calc(max(0px,calc(100dvw-1280px)/2))] z-[101] hidden max-h-[calc(90dvh+800px)] min-h-100 w-full max-w-500 -translate-x-1/2 flex-col rounded-t-[20px] bg-basic-white px-24 pb-[800px] transition-transform duration-0 ease-out scrollbar-hidden"
          >
