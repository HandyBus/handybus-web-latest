      ...
      <BottomSheetPortal>
        ...
        >
          <div
            ...
            className="fixed-centered-layout -bottom-[800px] z-[101] hidden max-h-[calc(90dvh+800px)] min-h-100 w-full max-w-500 flex-col rounded-t-[20px] bg-basic-white px-24 pb-[800px] transition-transform duration-0 ease-out scrollbar-hidden"
          >
