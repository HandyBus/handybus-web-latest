      ...
      <BottomSheetPortal>
        ...
        >
          <div
            ...
            className="fixed -bottom-[800px] left-0 right-0 z-[101] mx-auto hidden max-h-[calc(90dvh+800px)] min-h-100 w-full max-w-500 -translate-x-1/2 flex-col rounded-t-[20px] bg-basic-white px-24 pb-[800px] transition-transform duration-0 ease-out scrollbar-hidden"
          >
