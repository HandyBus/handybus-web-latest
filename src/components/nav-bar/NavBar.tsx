...
const NavBar = () => {
  ...
  return (
    <>
      <div className="fixed bottom-0 right-0 z-50 flex h-[58px] w-full max-w-500 items-center justify-center border-t border-basic-grey-200 bg-basic-white px-16">
