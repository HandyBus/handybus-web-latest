  ...
  return (
    <article className="space-y-16 leading-[22.4px]">
      <ul className="list-disc pl-16 text-14 font-400 text-basic-grey-600">
        ...
        <li>
          당일 행사 종료 시간에 따라 셔틀버스/핸디팟 운행 시간 또한 변경될 수
          있으며, 변경 시 공연 종료 전까지 문자로 안내드립니다.
        </li>
        <li>
          운행 일정이 변경될 경우 문자(MMS)로 안내드리니, 수신 차단을
          해제해주세요.
        </li>
        <li>
          본 셔틀 탑승권은 양도가 불가능하며, 양도 받은 탑승권은 탑승이 거부될
          수 있습니다.
        </li>
        <li>공지 미숙지로 인한 불이익에 대해 책임지지 않습니다.</li>
      </ul>
    </article>
  );
};
