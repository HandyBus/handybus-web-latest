...
const Coupon = ({ coupon }: Props) => {
  ...
  return (
    <div
      className={`rounded-[12px] bg-brand-grey-50 p-16 ${usable ? '' : 'opacity-50'}`}
    >
      {!usable && (
      ...
      <p className="line-clamp-1 pb-4 pt-[2px] text-16 font-500 text-brand-grey-700">
        {coupon.name}
      </p>
      <p className="line-clamp-1 text-12 font-400 text-brand-grey-500">
