      ...
      <section className="flex flex-col gap-16 px-16 py-24">
        ...
        <p className="text-12 font-500 leading-[160%] text-basic-grey-500">
          ...
          * 예약한 사람에게는 건 당 일괄 1,000원 할인이 적용됩니다.
          <br />
          * 초대 링크를 통한 예약은 1인 1회만 가능하며, 예약 취소 후 동일 링크로
          재예약 시에도 할인이 적용됩니다.
          <br />
          * 환급 금액은 행사일 이후, 영업일 기준 4일 이내에 지급됩니다.
          <br />
          * 링크를 받은 친구도 본인의 링크를 다시 공유하여 추가 할인을 받을 수
          있습니다.
          <br />
          * 초대 링크를 통한 결제 시, 친구 전용 링크 안내가 표시되는지 확인해
          주세요. 표시가 없는 경우 할인이 적용되지 않습니다.
          <br />
          * 최대 환급 금액은 탑승권 1인 기준 예약 금액의 100%이며, 초과 시 추가
          환급은 적용되지 않습니다.
          <br />* 할인(쿠폰, 얼리버드 등)을 적용하여 예매한 경우, 할인 적용
          금액은 최대 환급 금액에서 제외됩니다. 2인 이상 예매 시 할인 금액은
          예약 인원으로 나누어 최대 환급 금액에서 제외됩니다.
        </p>
      </section>
    </WrapperWithDivider>
  );
