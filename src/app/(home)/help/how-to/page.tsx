...
const HowToPage = () => {
  return (
    <>
      ...
      <Article richTitle="서비스 이용 절차" titleSize="large" className="py-28">
        ...
        <Article richTitle="3. 예약 마감" titleSize="small">
          <ul className="mt-12 list-outside list-disc px-16 pl-[34px] text-16  font-500 leading-[26px] text-grey-900">
            <li>
...
const Bold = ({ children }: PropsWithChildren) => (
  <span className="font-600 text-primary-main">{children}</span>
);
