    ...
    <>
      ...
      <main className="w-full flex-grow pb-12">
        <Article titleSize="large" richTitle="핸디버스의 ‘핸디’란?">
          <div className="w-full flex-col gap-8 px-16 pt-12 text-16 font-500 text-grey-700">
            핸디버스의 ‘핸디’는 안전한 셔틀 운행을 위한 현장 도우미예요. 셔틀 당
            선착순으로 한 분을 뽑아요.
          </div>
        </Article>
        <Article titleSize="small" richTitle="딱 이 세가지가 필요해요">
          <div className="flex w-full flex-col gap-8 px-16 pt-12">
        ...
        <Article titleSize="small" richTitle="이런 혜택이 있어요">
          <div className="mb-28 w-full flex-col gap-8 px-16 pt-12 text-16 font-500 text-grey-700">
            다음에 또 핸디버스를 이용하실 때{' '}
...
const Desc = ({
  ...
  return (
    <div className="flex size-16 h-fit w-full flex-row items-center gap-[10px] rounded-[8px] bg-grey-50 px-12 py-16 text-16 font-500">
      <span
        className={
      ...
      <span className="text-16 font-500 text-grey-700">{children}</span>
    </div>
  );
};
