  ...
  return (
    <>
      ...
      <article className="mx-16 mt-56">
        ...
        <p className="mt-4 text-16 font-500 leading-[25.6px] text-grey-700">
      ...
      <Article richTitle="1. 수요조사">
        <p className="ml-36 text-16 font-500 leading-[26px] text-grey-700">
          여러분의 관심도를 체크해요
        </p>
        <ul className="mt-12 list-outside list-disc px-16 pl-[34px] text-16 font-500 leading-[26px] text-grey-700">
          <li>
            <p className="py-[2px]">
              수요조사를 통해 목적지로 가는 셔틀 수요를 확인해요
            </p>
            <ul className="list-outside list-disc pl-[22px] text-16 font-500 text-grey-600">
              <li>
                <p className="py-[2px]">
