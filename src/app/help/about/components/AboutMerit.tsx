...
const AboutMerit = () => (
  <Article richTitle="이런 점이 좋아요" className="w-full">
    <div className="mx-16 mt-28 flex flex-col gap-16 border-l-2 border-l-brand-grey-50 pl-12 pt-12 text-brand-grey-700">
...
const MeritItem = ({ text, children }: MeritItemProps) => (
  <li className="flex items-start">
    <span className="mr-8 inline-block text-brand-grey-600">•</span>
