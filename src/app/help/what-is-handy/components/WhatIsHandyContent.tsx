...
const WhatIsHandyContent = () => {
  return (
    <div className="flex w-full grow flex-col gap-40">
      ...
      <section className="flex flex-col gap-8 px-16">
        ...
        <p className="text-16 font-400 text-basic-grey-700">
          ...
          예요. 셔틀 내에서 행사장까지의 여정을 원활하게 만들고, 팬들과의 소통을
          통해 즐거운 분위기를 만들어주는 중요한 역할을 해요. 즐거운 분위기를
          만들어주는 중요한 역할을 해요.
        </p>
...
export default WhatIsHandyContent;
