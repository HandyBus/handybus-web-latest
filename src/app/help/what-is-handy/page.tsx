      ...
      <main className="flex w-full grow flex-col gap-40 pb-12">
        ...
        <section className="flex flex-col gap-8 px-16">
          ...
          <p className="text-16 font-400 text-grey-700">
            함께 가는 팬들을 연결하는{' '}
            <span className="inline-block rounded-[4px] bg-[#E6FFF7] px-4 text-16 font-600 text-primary-main">
              커넥터 (Connector)
            </span>
            예요. 셔틀 내에서 행사장까지의 여정을 원활하게 만들고, 팬들과의
            소통을 통해 즐거운 분위기를 만들어주는 중요한 역할을 해요.
          </p>
        ...
        <section className="px-16">
          ...
          <p className="mb-32 text-16 font-400 text-grey-700">
        ...
        <section className="bg-grey-100 px-16 py-24">
          ...
          <ul className="list-disc pl-16 text-16 font-400 text-grey-500">
