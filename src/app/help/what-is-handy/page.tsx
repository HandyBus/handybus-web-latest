    ...
    <>
      ...
      <main className="flex w-full grow flex-col gap-40 pb-12">
        ...
        <section className="flex flex-col gap-8 px-16">
          ...
          <p className="text-16 font-400 text-brand-grey-700">
            함께 가는 팬들을 연결하는{' '}
            <span className="inline-block rounded-[4px] bg-[#E6FFF7] px-4 text-16 font-600 text-brand-primary-400">
              커넥터 (Connector)
            </span>
          ...
          <p className="text-14 font-400 text-brand-grey-400">
            * 핸디는 지원자 중 한 분만 선정돼요.
          </p>
        </section>
        <section className="px-16">
          <h2 className="mb-8 text-22 font-700">역할</h2>
          <p className="mb-32 text-16 font-400 text-brand-grey-700">
          ...
          <article className="mb-32">
            <h3 className="mb-12 flex h-24 items-center gap-8 text-18 font-600">
              <span className="rounded-[6px] bg-[#F3F3F3] px-8 text-brand-grey-700">
                1
              </span>
              출발/도착 알림
            </h3>
        ...
        <section className="px-16">
          ...
          <p className="mb-16 text-16 font-400 text-brand-grey-700">
          ...
          />
          <p className="text-12 font-400 text-brand-grey-400">
        ...
        <section className="bg-brand-grey-100 px-16 py-24">
          <h3 className="mb-8 text-18 font-700 text-brand-grey-700">
            유의사항
          </h3>
          <ul className="list-disc pl-16 text-16 font-400 text-brand-grey-500">
