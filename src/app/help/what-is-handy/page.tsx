    ...
    <>
      ...
      <main className="flex w-full grow flex-col gap-40 pb-12">
        ...
        <section className="flex flex-col gap-8 px-16">
          ...
          <p className="text-basic-grey-700 text-16 font-400">
            함께 가는 팬들을 연결하는{' '}
          ...
          <p className="text-basic-grey-400 text-14 font-400">
            * 핸디는 지원자 중 한 분만 선정돼요.
          </p>
        </section>
        <section className="px-16">
          <h2 className="mb-8 text-22 font-700">역할</h2>
          <p className="text-basic-grey-700 mb-32 text-16 font-400">
          ...
          <article className="mb-32">
            <h3 className="mb-12 flex h-24 items-center gap-8 text-18 font-600">
              <span className="text-basic-grey-700 rounded-[6px] bg-[#F3F3F3] px-8">
                1
              </span>
              출발/도착 알림
            </h3>
        ...
        <section className="px-16">
          ...
          <p className="text-basic-grey-700 mb-16 text-16 font-400">
          ...
          />
          <p className="text-basic-grey-400 text-12 font-400">
        ...
        <section className="bg-basic-grey-100 px-16 py-24">
          <h3 className="text-basic-grey-700 mb-8 text-18 font-700">
            유의사항
          </h3>
          <ul className="text-basic-grey-500 list-disc pl-16 text-16 font-400">
