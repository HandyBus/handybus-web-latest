...
const NotificationBubble = () => {
  return (
    <div className="absolute -top-[5px] right-[62px] flex -translate-y-full items-center gap-[2px] whitespace-nowrap break-keep rounded-full bg-basic-black px-8 py-[5px] text-10 font-600 text-basic-white">
      <NotificationIcon />
