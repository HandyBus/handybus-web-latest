          ...
          <Select
            ...
            renderValue={(value) => (
              <p className="flex items-center justify-between">
                <span className="font-600 text-grey-700 group-default/is-selected:font-400 group-disabled/select-option:font-400 group-disabled/select-option:text-grey-400 group-[.is-selected]:font-400">
                  {TRIP_STATUS_TO_STRING[value]}
                </span>
                <div className="flex items-center gap-12 group-[.is-selected]:hidden">
                  <span className="text-12 font-400 text-grey-700 group-disabled/select-option:hidden">
                    {getRemainingSeatCount(value)}석
                  </span>
                  <span className="hidden text-12 font-400 text-red-100 group-disabled/select-option:inline-block">
                    매진
                  </span>
                  <span className="text-14 font-600 text-grey-700 group-disabled/select-option:hidden">
