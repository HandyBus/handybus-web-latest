    ...
    <>
      <section className="flex flex-col gap-12 py-32">
              ...
              <>
                ...
                <Button
                  ...
                  className={`h-[42px] px-32 ${
                    value === true
                      ? 'bg-brand-grey-700 text-basic-white active:bg-brand-grey-500'
                      : 'bg-brand-grey-50 text-brand-grey-700 active:bg-brand-grey-100'
                  }`}
                  onClick={() => {
                    onChange(true);
                  }}
        ...
        <p>
          <button
            type="button"
            className="text-12 font-400 text-brand-grey-700 underline"
