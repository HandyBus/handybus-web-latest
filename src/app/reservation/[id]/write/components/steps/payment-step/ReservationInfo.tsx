  ...
  return (
    <>
      <section className="flex flex-col gap-16 py-28">
        <h2 className="text-22 font-700 text-basic-grey-700">
          신청 정보를 확인해주세요
        </h2>
...
const Item = ({ label, value }: ItemProps) => {
  return (
    <>
      <div className="text-16 font-400 leading-[24px] text-basic-grey-600">
        {label}
      </div>
      <div className="text-16 font-400 leading-[24px] text-basic-grey-700">
        {value}
      </div>
    </>
  );
