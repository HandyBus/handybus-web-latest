...
import { ReviewSortType } from './ReviewList';
...
const FilterButton = ({ sort, onSort }: FilterButtonProps) => {
  ...
  return (
    <div className="relative" ref={filterRef}>
      ...
      {filterOpen && (
        <div className="absolute right-0 top-44 w-[110px] z-50 rounded-[8px] border border-basic-grey-200 bg-basic-white shadow-lg">
          <button
