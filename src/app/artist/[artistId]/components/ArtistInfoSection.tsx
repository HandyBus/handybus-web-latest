...
const ArtistInfoSection = ({ description }: Props) => {
  return (
    <section className="px-16 py-24">
      ...
      {description ? (
        <p className="bg-[#F7F8F9] p-12 text-14 font-400 leading-[160%] text-basic-grey-600">
          {description}
        </p>
      ) : (
        <p className="bg-[#F7F8F9] p-12 text-14 font-500 leading-[160%] text-basic-grey-400">
