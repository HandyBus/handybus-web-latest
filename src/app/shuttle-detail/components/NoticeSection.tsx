  ...
  return (
    <article className="pt-16">
      <section className="rounded-[10px] bg-grey-50 p-16">
        <ul className="mb-16 space-y-8 text-14 font-400 leading-[22.4px] text-grey-500">
          <li>
      ...
      <section className="rounded-[10px] bg-grey-50 p-16 text-14 font-400 leading-[22.4px] text-grey-500">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              · 운행 무산 시 무상 결정 후 3일 이내로 전액 환불해 드립니다.
            </li>
            <li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              · 본 셔틀 티켓은 양도가 불가능하며, 탑승이 거부될 수 있습니다.
            </li>
        ...
        <section>
          ...
          <ul>
            <li>
              · 탑승자 대표인 &apos;핸디&apos;가 셔틀 운행 시 안전한 운행을
              도와주는 역할을 수행합니다. 핸디의 안내를 잘 따라주시기 바랍니다.
            </li>
