...
export const ArtistsInArtistViewEntitySchema = z.object({
  relationId: z.string(),
  artistId: z.string(),
  artistName: z.string(),
...
export const UserFavoriteArtistsInUsersViewEntitySchema = z.object({
  artistId: z.string(),
  artistName: z.string(),
  artistDisplayName: z.string().nullable(),
  artistAbbreviatedName: z.string().nullable(),
...
export const ArtistsViewEntitySchema = z.object({
  artistId: z.string(),
  artistName: z.string(),
